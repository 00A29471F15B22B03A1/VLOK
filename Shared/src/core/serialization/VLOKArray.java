...
public class VLOKArray extends VLOKBase {
    ...
    public static VLOKArray Byte(String name, byte[] data) {
        VLOKArray array = new VLOKArray();
        array.setName(name);
    ...
    public static VLOKArray Short(String name, short[] data) {
        VLOKArray array = new VLOKArray();
        array.setName(name);
    ...
    public static VLOKArray Char(String name, char[] data) {
        VLOKArray array = new VLOKArray();
        array.setName(name);
    ...
    public static VLOKArray Integer(String name, int[] data) {
        VLOKArray array = new VLOKArray();
        array.setName(name);
    ...
    public static VLOKArray Long(String name, long[] data) {
        VLOKArray array = new VLOKArray();
        array.setName(name);
    ...
    public static VLOKArray Float(String name, float[] data) {
        VLOKArray array = new VLOKArray();
        array.setName(name);
    ...
    public static VLOKArray Double(String name, double[] data) {
        VLOKArray array = new VLOKArray();
        array.setName(name);
    ...
    public static VLOKArray Boolean(String name, boolean[] data) {
        VLOKArray array = new VLOKArray();
        array.setName(name);
    ...
    public static VLOKArray Deserialize(byte[] data, int pointer) {
        byte containerType = data[pointer++];
        assert (containerType == CONTAINER_TYPE);

        VLOKArray result = new VLOKArray();
