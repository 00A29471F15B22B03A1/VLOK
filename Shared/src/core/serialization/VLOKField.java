...
public class VLOKField extends VLOKBase{
    ...
    public static VLOKField Byte(String name, byte value) {
        VLOKField field = new VLOKField();
        field.setName(name);
    ...
    public static VLOKField Short(String name, short value) {
        VLOKField field = new VLOKField();
        field.setName(name);
    ...
    public static VLOKField Char(String name, char value) {
        VLOKField field = new VLOKField();
        field.setName(name);
    ...
    public static VLOKField Integer(String name, int value) {
        VLOKField field = new VLOKField();
        field.setName(name);
    ...
    public static VLOKField Long(String name, long value) {
        VLOKField field = new VLOKField();
        field.setName(name);
    ...
    public static VLOKField Float(String name, float value) {
        VLOKField field = new VLOKField();
        field.setName(name);
    ...
    public static VLOKField Double(String name, double value) {
        VLOKField field = new VLOKField();
        field.setName(name);
    ...
    public static VLOKField Boolean(String name, boolean value) {
        VLOKField field = new VLOKField();
        field.setName(name);
    ...
    public static VLOKField Deserialize(byte[] data, int pointer) {
        byte containerType = data[pointer++];
        assert(containerType == CONTAINER_TYPE);

        VLOKField result = new VLOKField();
